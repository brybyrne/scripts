...
'''
This is a fairly basic funciton to read in information from two lists and generate 'config' of those details.

devices is a list of hostnames
vlans is a list of dicts containing the individual configuraiton components
'''
